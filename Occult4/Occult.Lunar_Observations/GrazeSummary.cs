...
{
	public class GrazeSummary : Form
	{
		...
		{
			Settings.Default.Save_LunarPredictions = Output.SavePredictionText(CollectEvents(), "Graze Summary", Settings.Default.Save_LunarPredictions);
		}

		private string CollectEvents()
		{
			StringBuilder stringBuilder = new StringBuilder();
			int count = lstGrazes.get_Items().get_Count();
		...
		private void GrazeSummary_Load(object sender, EventArgs e)
		{
		...
		private void InitializeComponent()
		{
			...
			((Control)menuStrip1).set_Size(new Size(337, 24));
			...
			((Control)lstGrazes).set_Location(new Point(5, 39));
			((Control)lstGrazes).set_Name("lstGrazes");
			((Control)lstGrazes).set_Size(new Size(325, 326));
			lstGrazes.set_Sorted(true);
			((Control)lstGrazes).set_TabIndex(1);
			((ContainerControl)this).set_AutoScaleDimensions(new SizeF(6f, 13f));
			((ContainerControl)this).set_AutoScaleMode((AutoScaleMode)1);
			((Form)this).set_ClientSize(new Size(337, 377));
			((Control)this).get_Controls().Add((Control)(object)lstGrazes);
			((Control)this).get_Controls().Add((Control)(object)menuStrip1);
			((Control)this).set_Font(new Font("Microsoft Sans Serif", 8.25f, FontStyle.Regular, GraphicsUnit.Point, 0));
			((Form)this).set_FormBorderStyle((FormBorderStyle)2);
			((Form)this).set_MainMenuStrip(menuStrip1);
			((Control)this).set_Name("GrazeSummary");
			((Control)this).set_Text("Summary of grazes used");
			((Form)this).add_Load((EventHandler)GrazeSummary_Load);
