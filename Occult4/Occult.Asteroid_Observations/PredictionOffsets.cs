...
{
	public class PredictionOffsets : Form
	{
		...
		internal ListBox lstPredictions;
		...
		public PredictionOffsets()
		{
			InitializeComponent();
		}

		private void PredictionOffsets_Activated(object sender, EventArgs e)
		{
			Data_and_Plots.PredictionOffsets();
		}
		...
		{
			Settings.Default.Save_AsteroidPredictions = Output.SaveAppendPredictionText(CollectEvents(), "Prediction Offset (" + EventDetails.AsteroidNominalDiameter + ") " + EventDetails.FormattedDate, Settings.Default.Save_AsteroidPredictions);
		}
		...
		{
			Help.ShowHelp((Control)(object)this, Utilities.AppPath + "\\Occult.chm", (HelpNavigator)(-2147483642), (object)"Asteroid observations - prediction offsets");
		}

		private void PredictionOffsets_Load(object sender, EventArgs e)
		{
		...
		private void InitializeComponent()
		{
			...
			((Control)lstPredictions).set_Location(new Point(1, 31));
			((Control)lstPredictions).set_Name("lstPredictions");
			((Control)lstPredictions).set_Size(new Size(659, 158));
			((Control)lstPredictions).set_TabIndex(0);
			...
			((Control)menuStrip1).set_Size(new Size(663, 24));
			...
			((Form)this).set_ClientSize(new Size(663, 192));
			((Control)this).get_Controls().Add((Control)(object)lstPredictions);
			((Control)this).get_Controls().Add((Control)(object)menuStrip1);
			((Control)this).get_DataBindings().Add(new Binding("Location", (object)Settings.Default, "LocationAsterPredictionOffset", true, (DataSourceUpdateMode)1));
			((Control)this).set_Font(new Font("Microsoft Sans Serif", 8.25f, FontStyle.Regular, GraphicsUnit.Point, 0));
			((Form)this).set_Location(Settings.Default.LocationAsterPredictionOffset);
			((Form)this).set_MainMenuStrip(menuStrip1);
			((Control)this).set_Name("PredictionOffsets");
			((Control)this).set_Text("Prediction offsets");
			((Form)this).add_Activated((EventHandler)PredictionOffsets_Activated);
			((Form)this).add_Load((EventHandler)PredictionOffsets_Load);
