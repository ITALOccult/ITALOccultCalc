...
{
	public class DisplayLargeUncert : Form
	{
		private IContainer components;

		private Label label5;

		internal ListBox lstLargeUncert;
		...
		public DisplayLargeUncert()
		{
			InitializeComponent();
		}

		private void DisplayLargeUncert_Load(object sender, EventArgs e)
		{
		}

		private void lstLargeUncert_MouseDown(object sender, MouseEventArgs e)
		{
			...
			try
			{
				string text = lstLargeUncert.get_SelectedItem().ToString();
				...
				string asteroidNumber = text.Substring(12, 7);
				string asteroidName = "";
		...
		private void DisplayLargeUncert_Resize(object sender, EventArgs e)
		{
			...
			((Control)lstLargeUncert).set_Height(((Control)this).get_Height() - 74);
		}

		private void copySelectedToolStripMenuItem_Click_1(object sender, EventArgs e)
		{
		...
		private string CollectEvents(bool NoPlusMinus, bool SelectedLinesOnly)
		{
			...
			int count = lstLargeUncert.get_Items().get_Count();
			if (SelectedLinesOnly)
			{
				for (int i = 0; i < lstLargeUncert.get_SelectedItems().get_Count(); i++)
				{
					string value = lstLargeUncert.get_SelectedItems().get_Item(i).ToString()!.Replace("±", " ");
			...
			else
			{
				...
				{
					string value2 = lstLargeUncert.get_Items().get_Item(j).ToString()!.Replace("±", " ");
		...
		private void InitializeComponent()
		{
			...
			((Control)label5).set_Location(new Point(115, 7));
			...
			((Control)lstLargeUncert).set_Font(new Font("Courier New", 8.25f, FontStyle.Regular, GraphicsUnit.Point, 0));
			((ListControl)lstLargeUncert).set_FormattingEnabled(true);
			lstLargeUncert.set_ItemHeight(14);
			((Control)lstLargeUncert).set_Location(new Point(1, 31));
			((Control)lstLargeUncert).set_Name("lstLargeUncert");
			lstLargeUncert.set_SelectionMode((SelectionMode)3);
			((Control)lstLargeUncert).set_Size(new Size(337, 340));
			((Control)lstLargeUncert).set_TabIndex(22);
			((Control)lstLargeUncert).add_MouseDown(new MouseEventHandler(lstLargeUncert_MouseDown));
			...
			((ToolStripItem)copySelectedToolStripMenuItem).set_Size(new Size(146, 22));
			((ToolStripItem)copySelectedToolStripMenuItem).set_Text("copy selected");
			((ToolStripItem)copySelectedToolStripMenuItem).add_Click((EventHandler)copySelectedToolStripMenuItem_Click_1);
			((ToolStripItem)copyAllToolStripMenuItem).set_Name("copyAllToolStripMenuItem");
			((ToolStripItem)copyAllToolStripMenuItem).set_Size(new Size(146, 22));
			((ToolStripItem)copyAllToolStripMenuItem).set_Text("copy All");
			((ToolStripItem)copyAllToolStripMenuItem).add_Click((EventHandler)copyAllToolStripMenuItem_Click_1);
			((ContainerControl)this).set_AutoScaleDimensions(new SizeF(6f, 13f));
			((ContainerControl)this).set_AutoScaleMode((AutoScaleMode)1);
			((Form)this).set_ClientSize(new Size(341, 375));
			((Control)this).get_Controls().Add((Control)(object)label5);
			((Control)this).get_Controls().Add((Control)(object)lstLargeUncert);
			((Control)this).get_Controls().Add((Control)(object)menuStrip1);
			((Control)this).set_Name("DisplayLargeUncert");
			((Control)this).set_Text("Large Uncertainty relative to diameter");
			((Form)this).add_Load((EventHandler)DisplayLargeUncert_Load);
			((Control)this).add_Resize((EventHandler)DisplayLargeUncert_Resize);
