...
% Font: Iwona (elegant sans-serif similar to Optima)
\usepackage{iwona}    % Iwona - elegant sans-serif
...
\include{chapters/02b_celestial_mechanics}  % NEW: Detailed celestial mechanics
\include{chapters/03_time_systems}
\include{chapters/04_planetary_ephemerides}
\include{chapters/04b_earth_position_optimizations}  % NEW: Recent optimizations
...
\include{chapters/17_database_system}  % NEW: Database implementation
\include{chapters/18_performance_optimization}  % NEW: Cache, interpolation
\include{chapters/19_occultation_search}  % NEW: Complete occultation search workflow

% Appendices
\appendix
\include{appendices/appendix_a_constants}
\include{appendices/appendix_b_algorithms}
\include{appendices/appendix_c_vsop_tables}
